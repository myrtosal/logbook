 ...
 * @author Savvas
 */
public class get_top10_user_posts extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Post> posts = getTop10RecentPostsOfUser(username);
            int i = 0;
            for (Post post : posts) {
                ...
                out.println("<h5 onclick=\"javascript:show_user_info();\">" + filter(post.getUserName()) + "</h5>");
                ...
                if (!post.getImageBase64().equals("") && post.getImageBase64() != null && !post.getImageBase64().equals("null")) {
                    ...
                    //out.println("<canvas class=\"canvades\" id=\"canvas" + i + "\"> </canvas>");
            ...
            Logger.getLogger(get_top10_user_posts.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
