...
public class CS359DB {
    ...
    private static final String UNAME = "csd3741"; // Share your repo to give you the credentials
    private static final String PASSWD = "Mh#4k8$F";  // Share your repo to give you the credentials
