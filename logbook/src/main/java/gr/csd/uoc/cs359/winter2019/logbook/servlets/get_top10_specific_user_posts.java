 ...
 * @author Savvas
 */
public class get_top10_specific_user_posts extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (Post post : posts) {
                ...
                if (!post.getImageBase64().equals("")) {
                    ...
                    out.println("</div>");
                } else if (!post.getImageURL().equals("") && post.getImageBase64().equals("")) {
                    out.println("<div class=\"image_area\" id=\"image_area" + i + "\">");
            ...
            Logger.getLogger(get_top10_specific_user_posts.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
